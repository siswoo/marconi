            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Gestionar Permisos</h1>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group form-check">
                                ...
                                <input type="time" id="desde1" name="desde1" class="form-control" required>
                            </div>
                            <div class="col-md-12 form-group form-check">
                                <label for="hasta1" style="font-weight: bold;">Hasta *</label>
                                <input type="time" id="hasta1" name="hasta1" class="form-control" required>
                            </div>
                            <div class="col-md-12 form-group form-check">
                                <label for="tipo1" style="font-weight: bold;">Tipo *</label>
                                <select class="form-control" name="tipo1" id="tipo1" required>
                                    <option value="">Seleccione</option>
                                    <option value="Goce de salario">Goce de salario</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group form-check">
                                <label for="desde2" style="font-weight: bold;">Desde *</label>
                                <input type="time" id="desde2" name="desde2" class="form-control" required>
                            </div>
                            <div class="col-md-12 form-group form-check">
                                <label for="hasta2" style="font-weight: bold;">Hasta *</label>
                                <input type="time" id="hasta2" name="hasta2" class="form-control" required>
                            </div>
                            <div class="col-md-12 form-group form-check">
                                <label for="tipo2" style="font-weight: bold;">Tipo *</label>
...
<script type="text/javascript">
    ...
    function cambioEstatus(id,estatus){
        Swal.fire({
          ...
          confirmButtonText: 'Si, aceptar registro!',
